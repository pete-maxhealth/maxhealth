...
| `mh_treatment_log` | Treatment Tracking — a growing array of real timestamped sessions (`{id, treatmentId, date, time}`), NOT a daily-reset snapshot like symptom/supplement logs — this is what makes before/during/after-session reporting possible |
